...
Ссылка на VS Code - [Официальный источник](https://visualstudio.microsoft.com/ru/downloads/ "тыкай")  
Также ссылка на официальныый репозиторий VS Code -  [Официальный источник]( https://github.com/code-visualstudio-com-download "тыкай") 
